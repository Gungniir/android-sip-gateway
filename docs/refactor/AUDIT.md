...
#### H16. The SMS send outcome still arrives on main, so SMS cannot be published — NEW, P2 — filed as GW-46
...
| P2 | 13 | resource hygiene, correctness, observability, security |
